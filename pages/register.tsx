    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <Container className="py-5">
          <p className={styles.formTitle}>Bem-vindo(a) ao SkillUp!</p>
          <Form className={styles.form} onSubmit={handleRegister}>
            ...
            <FormGroup>
              ...
              <Input id="birth" name="birth" type="date" min="1930-01-01" max="2020-12-31" required className={styles.input} />
            </FormGroup>
            <FormGroup>
